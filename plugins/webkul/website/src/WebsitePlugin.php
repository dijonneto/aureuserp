...
class WebsitePlugin implements Plugin
{
    ...
    protected function getTopNavigationItems(): Collection
    {
        return new Collection([
            NavigationItem::make(fn () => __('website::filament/app.navigation.top.login'))
                ->url(filament()->getLoginUrl())
                ->visible(! Filament::auth()->check()),
            NavigationItem::make(fn () => __('website::filament/app.navigation.top.register'))
    ...
    {
        $navigationItems = new Collection([
            NavigationItem::make(fn () => __('website::filament/app.navigation.footer.home'))
                ->url('/'),
        ]);
    ...
    protected function getSocialLinks(): Collection
    {
        ...
        if ($contactSettings->facebook) {
            $socialLinks->push(
                NavigationItem::make(fn () => __('website::filament/app.navigation.social.facebook'))
        ...
        if ($contactSettings->twitter) {
            $socialLinks->push(
                NavigationItem::make(fn () => __('website::filament/app.navigation.social.twitter'))
        ...
        if ($contactSettings->instagram) {
            $socialLinks->push(
                NavigationItem::make(fn () => __('website::filament/app.navigation.social.instagram'))
        ...
        if ($contactSettings->youtube) {
            $socialLinks->push(
                NavigationItem::make(fn () => __('website::filament/app.navigation.social.youtube'))
        ...
        if ($contactSettings->linkedin) {
            $socialLinks->push(
                NavigationItem::make(fn () => __('website::filament/app.navigation.social.linkedin'))
        ...
        if ($contactSettings->pinterest) {
            $socialLinks->push(
                NavigationItem::make(fn () => __('website::filament/app.navigation.social.pinterest'))
        ...
        if ($contactSettings->tiktok) {
            $socialLinks->push(
                NavigationItem::make(fn () => __('website::filament/app.navigation.social.tiktok'))
        ...
        if ($contactSettings->github) {
            $socialLinks->push(
                NavigationItem::make(fn () => __('website::filament/app.navigation.social.github'))
        ...
        if ($contactSettings->whatsapp) {
            $socialLinks->push(
                NavigationItem::make(fn () => __('website::filament/app.navigation.social.whatsapp'))
        ...
        if ($contactSettings->slack) {
            $socialLinks->push(
                NavigationItem::make(fn () => __('website::filament/app.navigation.social.slack'))
