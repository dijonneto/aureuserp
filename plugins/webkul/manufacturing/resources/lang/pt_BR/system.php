...
return [
    'manufacturing-manager' => [
        'unplan-order' => [
            'work-orders-already-done' => 'Algumas ordens de trabalho já foram concluídas, então você não pode desplanejar esta ordem de produção.\\n\\nSeria uma pena desperdiçar todo esse progresso, certo?',
            'work-orders-already-started' => 'Algumas ordens de trabalho já foram iniciadas, então você não pode desplanejar esta ordem de produção.\\n\\nSeria uma pena desperdiçar todo esse progresso, certo?',
        ],
    ],
