        ...
        'actions' => [
            ...
            'delete' => [
                'notification' => [
                    ...
                    'default-company' => [
                        'title' => 'A empresa não pode ser excluída',
                        'body' => 'Esta empresa está definida como a empresa padrão nas configurações de Gerenciar usuários. Altere a empresa padrão antes de excluir.',
                    ],
                ],
            ],
            ...
            'force-delete' => [
                'notification' => [
                    ...
                    'error' => [
                        'title' => 'Não foi possível excluir a empresa permanentemente',
                        'body' => 'Esta empresa está associada a registros existentes e não pode ser excluída.',
                    ],
                ],
            ],
        ],
        ...
        'bulk-actions' => [
            ...
            'force-delete' => [
                'notification' => [
                    ...
                    'error' => [
                        'title' => 'Não foi possível excluir empresas permanentemente',
                        'body' => 'Uma ou mais empresas estão associadas a registros existentes e não podem ser excluídas.',
                    ],
                ],
            ],
        ],
